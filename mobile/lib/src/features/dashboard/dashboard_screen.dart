...
class _DashboardScreenState extends ConsumerState<DashboardScreen> {
  ...
  final Color primaryGreen = const Color(0xFF2E7D32); // Kijani nzuri ya biashara
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              Text('Set Up Your Shop 🛍️', 
                style: TextStyle(fontSize: 32, fontWeight: FontWeight.w900, color: widget.primaryGreen)),
              const SizedBox(height: 12),
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  ...
                  prefixIcon: Icon(Icons.storefront_rounded, color: widget.primaryGreen),
                  filled: true,
                  ...
                  return Padding(
                    ...
                    child: InkWell(
                      ...
                      child: AnimatedContainer(
                        ...
                        padding: const EdgeInsets.all(16),
                        decoration: BoxDecoration(
                          color: isSelected ? widget.primaryGreen : Colors.grey.shade50,
                          borderRadius: BorderRadius.circular(16),
                          border: Border.all(
                            color: isSelected ? widget.primaryGreen : Colors.grey.shade200,
                            width: 2
                          ),
                        ),
                        child: Row(
