...
class _DashboardScreenState extends ConsumerState<DashboardScreen> {
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          CircleAvatar(
            ...
            child: Text(_userData?['name']?[0]?.toUpperCase() ?? 'U', 
            ...
            child: Column(
              ...
              children: [
                CircleAvatar(
                  ...
                  child: Text(
                    _userData?['name']?[0]?.toUpperCase() ?? 'R',
          ...
          Expanded(
            child: ListView(
              ...
              children: [
                ...
                _buildDrawerItem(Icons.storefront_outlined, 'Shops', trailing: '2 >'),
                _buildDrawerItem(Icons.people_outline, 'Members', trailing: '0 >'),
                _buildDrawerItem(Icons.person_search_outlined, 'Customers', trailing: '0 >'),
                _buildDrawerItem(Icons.local_shipping_outlined, 'Suppliers', trailing: '1 >'),
                _buildDrawerItem(Icons.inventory_2_outlined, 'Products', trailing: '0 >'),
                const Divider(),
                _buildDrawerItem(Icons.article_outlined, 'Articles', trailing: 'New'),
                const Divider(),
  ...
  Widget _buildDrawerItem(IconData icon, String title, {String? trailing, bool isSelected = false}) {
    return ListTile(
  ...
  Widget _buildBusinessSelector() {
    final businessName = _userData?['business']?['name'] ?? 'Select Business';
    return Container(
      width: double.infinity,
  ...
  Widget _buildFeatureGrid() {
    return GridView.count(
      ...
      children: [
        _FeatureCard(title: 'Customers', subtitle: 'Manage Borrowers, clients & profiles', icon: Icons.people_outline, color: primaryGreen),
...
class _FeatureCard extends StatelessWidget {
  ...
  final IconData icon;
  final Color color;
  const _FeatureCard({required this.title, required this.subtitle, required this.icon, required this.color});
  @override
  Widget build(BuildContext context) {
    return Container(
      padding: const EdgeInsets.all(16),
