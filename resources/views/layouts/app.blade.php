...
<head>
    ...
    <title>{{ config('app.name', 'Dukafy') }}</title>

    <link rel="icon" href="{{ asset('freepik__letter_dukafy_word_make_it_cool_with_green_co.png') }}">
    <link rel="apple-touch-icon" href="{{ asset('freepik__letter_dukafy_word_make_it_cool_with_green_co.png') }}">
...
<body>
    <div id="app">
        @unless (request()->routeIs('login', 'register', 'password.request', 'password.email', 'password.reset', 'password.update', 'password.confirm', 'verification.notice', 'verification.verify', 'verification.send', 'verification.resend'))
            <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
                <div class="container">
                    <a class="navbar-brand" href="{{ url('/') }}">
                        {{ config('app.name', 'Dukafy') }}
                    </a>
