<header class="landing-header">
    <div class="landing-topbar">
        <div class="landing-container landing-topbar-inner">
            <div class="landing-topbar-left">
                ...
                <a class="landing-topbar-link" href="mailto:{{ $siteContact->email ?? 'support@malkiakonnect.co.tz' }}">
                    <span class="landing-topbar-icon" aria-hidden="true">
                        <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <span>{{ $siteContact->email ?? 'support@malkiakonnect.co.tz' }}</span>
                </a>
            </div>

            <div class="landing-topbar-right">
                <a class="landing-social" href="{{ $siteContact->instagram_url ?? 'https://instagram.com/malkiakonnect' }}" target="_blank" rel="noreferrer">
                    <span class="landing-topbar-icon" aria-hidden="true">
                        <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="landing-container landing-header-inner">
        <a class="landing-brand" href="{{ url('/') }}">
            <img class="landing-logo" src="{{ asset('LOGO-MALKIA-KONNECT-removebg-preview.png') }}" alt="Malkia Konnect" />
        </a>

        <nav class="landing-nav">
            <a class="landing-nav-link" href="{{ url('/') }}">Home</a>
            <a class="landing-nav-link" href="{{ route('articles') }}">Articles</a>
            <a class="landing-nav-link" href="#">Shop</a>
            <a class="landing-nav-link" href="#">Konnect</a>
            <a class="landing-nav-link" href="#">Resources</a>
            <a class="landing-nav-link" href="{{ route('about') }}">About</a>
        </nav>

        <div class="landing-nav-actions">
            @if (Route::has('register'))
                <a class="landing-nav-cta" href="{{ route('register') }}">Join Konnect</a>
            @elseif (Route::has('login'))
                <a class="landing-nav-cta" href="{{ route('login') }}">Join Konnect</a>
            @endif
        </div>
    </div>
</header>
