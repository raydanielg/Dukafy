...
<head>
    ...
    <title>About Us – {{ config('app.name', 'Malkia Konnect') }}</title>
...
<body class="landing-body">
    ...
    <main>
        ...
        @include('landing.partials.purpose')
        @include('landing.partials.what_we_do')
        ...
        @include('landing.partials.commitment')
    </main>
    ...
    @if($siteContact && $siteContact->phone)
        <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $siteContact->phone) }}" 
           class="whatsapp-float animate__animated animate__bounceIn" 
           target="_blank" 
           rel="noreferrer"
