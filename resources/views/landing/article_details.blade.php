            ...
            <div class="article-main-layout">
                    ...
                    <header class="article-details-header animate__animated animate__fadeInUp">
                        ...
                        <div class="article-author-info">
                            <div class="author-avatar">
                                <img src="{{ asset('freepik__letter_dukafy_word_make_it_cool_with_green_co.png') }}" alt="Dukafy">
                            </div>
                            <div class="author-details">
                                <span class="author-name">Dukafy Team</span>
                ...
                <aside class="article-sidebar animate__animated animate__fadeInRight">
                    ...
                    <div class="sidebar-card newsletter-sidebar">
                        <h4>Jiunge na Dukafy</h4>
                        <p>Pata maboresho na vidokezo vya kuendesha biashara kwa ufanisi.</p>
