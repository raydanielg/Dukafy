        ...
        <div class="admin-nav-group">
            ...
            <div class="admin-menu" data-admin-menu>
                ...
                <div class="admin-submenu" data-admin-submenu>
                    <a class="admin-sub-link" href="#">All Users</a>
                    <a class="admin-sub-link" href="#">Add New User</a>
                    <a class="admin-sub-link" href="#">User Roles</a>
                    <a class="admin-sub-link" href="#">Role Permissions</a>
                    <a class="admin-sub-link" href="#">Banned Users</a>
                    <a class="admin-sub-link" href="#">Pending Approvals</a>
