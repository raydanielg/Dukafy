...
<div class="admin-page animate__animated animate__fadeIn">
    <div class="admin-page-head">
        <div class="admin-page-title">Expiring Soon</div>
        <div class="text-muted">From {{ $from }} to {{ $to }}</div>
    </div>
            ...
            <div class="table-responsive">
                <table class="table align-middle">
                    ...
                    <tbody>
                        ...
                        @empty
                            <tr>
                                <td colspan="3" class="text-center text-muted py-4">No subscriptions expiring soon.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
