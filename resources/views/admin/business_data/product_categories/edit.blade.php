...
<div class="admin-page">
    <div class="admin-page-head">
        <div class="admin-page-title">Edit Product Category</div>
    ...
    <div class="admin-panel">
        <div class="admin-panel-body">
            <form method="POST" action="{{ route('admin.business_data.product_categories.update', $category->id) }}">
                @csrf
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="business_id" class="form-select" required>
                            @foreach($businesses as $b)
                                <option value="{{ $b->id }}" @selected(old('business_id', $category->business_id) == $b->id)>{{ $b->name }}</option>
                            @endforeach
                        </select>
                    </div>
